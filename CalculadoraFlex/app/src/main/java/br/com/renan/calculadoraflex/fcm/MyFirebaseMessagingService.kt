package br.com.renan.calculadoraflex.fcm
...
import br.com.renan.calculadoraflex.utils.NotificationManagerUtils
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun showNotification(pendingIntent: PendingIntent?, title: String, message: String) {
        ...
        val mNotificationManager = applicationContext.getSystemService(Context.NOTIFICATION_SERVICE)
